...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var HomePage        = __webpack_require__(1)
	        , SearchPage    = __webpack_require__(2)
	        , SettingsPage  = __webpack_require__(3);
	                            ...
	                            React.createElement("div", {className: "container-fluid"}, 
	                                React.createElement("div", {className: "navbar-header"}, 
	                                    React.createElement("button", {type: "button", className: "navbar-toggle collapsed", 'data-toggle': "collapse", 'data-target': "#navbar-collapse"}, 
	                                        React.createElement("span", {className: "sr-only"}, "Navigator"), 
	                                        React.createElement("span", {className: "icon-bar"}), 
	                                        React.createElement("span", {className: "icon-bar"}), 
	                                        React.createElement("span", {className: "icon-bar"})
	                                    ), 
	                                    React.createElement("a", {className: "navbar-brand", href: "#/"}, "Nightlife 2")
	                                ), 
	                                React.createElement("div", {className: "collapse navbar-collapse", id: "navbar-collapse"}, 
	                                    React.createElement("ul", {className: "nav navbar-nav"}, 
	                                        ...
	                                        React.createElement("li", null, React.createElement("a", {href: "#/search"}, React.createElement("span", {className: "glyphicon glyphicon-search"}), " Suche")), 
	                                        React.createElement("li", null, React.createElement("a", {href: "#/settings"}, React.createElement("span", {className: "glyphicon glyphicon-cog"}), " Einstellungen"))
	                                    )
	                                )
	                            )
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var HomePage = React.createClass({displayName: 'HomePage',
	        render: function () {
	            return (
	                React.createElement("h1", null, "Your didelidoo HomePage!")
	            );
	        }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var remote      = __webpack_require__(5)
	        , util      = remote.require('./client/util')
	        , client    = remote.require('tvdb-api-client');

	    var SeriesIndex = __webpack_require__(7);
	        ...
	        render: function () {
	            return (
	                React.createElement("section", null, 
	                                    ...
	                                    React.createElement("div", {className: "input-group"}, 
	                                        ...
	                                        React.createElement("span", {className: "input-group-btn"}, 
	                                            React.createElement("button", {className: "btn btn-success", type: "button", onClick: this.searchSeries}, 
	                                                React.createElement("span", {className: "glyphicon glyphicon-search"}), " Los!"
	                                            )
	                                        )
	                                    )
	                                )
	                    ...
	                    React.createElement("div", {className: 'alert alert-warning ' + (this.state.queryStarted && !this.state.serieslist.length ? 'show' : 'hide'), 
	                        role: "alert"}, 
	                        React.createElement("p", null, "Es wurden keine Serien unter dem Namen “", this.state.query, "” gefunden.")
	                    ), 
	                    React.createElement("div", {className: '' + (this.state.serieslist.length ? 'show' : 'hide')}, 
	                        React.createElement(SeriesIndex, {data: this.state.serieslist})
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var SettingsPage = React.createClass({displayName: 'SettingsPage',
	        render: function () {
	            return (
	                React.createElement("h1", null, "Your didelidoo SettingsPage!")
	            );
	        }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React, _) {/** @jsx React.DOM */
	            ...
	            return (
	                React.createElement("section", null, 
	                    _.map(this.props.data, function (item) {
	                        return (
	                            React.createElement("div", {key: item.id.toString() + item.language, 
	                                className: 'panel panel-' + (item.language === util.conf.getValue('language') ? 'success' : 'danger')}, 
	                                React.createElement("div", {className: "panel-heading", style: {minHeight: '69px'}}, 
	                                    React.createElement("div", {className: "panel-title"}, 
	                                        React.createElement("h2", {className: "col-md-10"}, item.name), 
	                                        React.createElement("div", {className: "btn-group pull-right"}, 
	                                            React.createElement("button", {type: "button", className: "btn btn-primary", onClick: this.showDetails.bind(null, item)}, 
	                                    ...
	                                    React.createElement("table", {className: "table"}, 
	                                        React.createElement("thead", null, 
	                                            React.createElement("tr", null, 
	                                                React.createElement("th", {width: "15%"}, "ID: ", item.id || '?'), 
	                                                React.createElement("th", {width: "20%"}, "Sprache: ", _.find(this.state.supportedLanguages, {abbreviation: item.language}).name || '?'), 
	                                                React.createElement("th", {width: "45%"}, "Sender: ", item.network || '?'), 
	                                                React.createElement("th", {width: "20%"}, "Erstausstrahlung: ", item.firstAired || '?')
	                                            )
	                                        ), 
	                                        React.createElement("tbody", null, 
	                                            React.createElement("tr", null, 
	                                                React.createElement("td", null, "Inhalt:"), 
	                                                React.createElement("td", {colSpan: "3"}, item.overview || 'Keine Inhaltsangabe verfügbar.')
	                                            ), 
	                                            React.createElement("tr", {style: item.alias.length ? {} : {display: 'none'}}, 
	                                                React.createElement("td", null, "Alternative Titel:"), 
	                                                React.createElement("td", {colSpan: "3"}, 
	                                                    React.createElement("ul", null, 
	                                                        _.map(item.alias.split('|'), function (alias, idx) {
	                                                            if (alias.length) {
	                                                                return (
	                                                                    React.createElement("li", {key: idx}, alias)
	                                                                );
	                                                            }
	                                                        })
	                                                    )
	                                            ...
	                                            React.createElement("tr", {style: item.banner.length ? {} : {display: 'none'}}, 
	                                                React.createElement("td", {colSpan: "4"}, 
	                                                    React.createElement("img", {className: "thumbnail center-block", src: 'http://thetvdb.com/banners/' + item.banner})
	                                                )
	                                            )
	                                        )
	                                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/home/cid/workspace/github.com/nightlife2/node_modules/css-loader/index.js!/home/cid/workspace/github.com/nightlife2/node_modules/less-loader/index.js!/home/cid/workspace/github.com/nightlife2/client/styles/page.less", function() {
			var newContent = require("!!/home/cid/workspace/github.com/nightlife2/node_modules/css-loader/index.js!/home/cid/workspace/github.com/nightlife2/node_modules/less-loader/index.js!/home/cid/workspace/github.com/nightlife2/client/styles/page.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(27);
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(33);
	  React.addons.TestUtils = __webpack_require__(34);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classSet = __webpack_require__(30);
	var objectAssign = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActiveContext = __webpack_require__(37);
	var LocationContext = __webpack_require__(38);
	var RouteContext = __webpack_require__(39);
	var ScrollContext = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDefaultPerfAnalysis = __webpack_require__(87);
	var ReactMount = __webpack_require__(66);
	var ReactPerf = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationActions = __webpack_require__(95);
	var getWindowPath = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(94);
	var invariant = __webpack_require__(49);
	var canUseDOM = __webpack_require__(74).canUseDOM;
	var HashLocation = __webpack_require__(36);
	var HistoryLocation = __webpack_require__(97);
	var RefreshLocation = __webpack_require__(98);
	var PathStore = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(49);
	var canUseDOM = __webpack_require__(74).canUseDOM;
	var ImitateBrowserBehavior = __webpack_require__(101);
	var ScrollToTopBehavior = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(49);
	var merge = __webpack_require__(110).merge;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(104)(module), __webpack_require__(45)))
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
		...
		var makePromise = __webpack_require__(197);
		var Scheduler = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(215);
	var getMarkupWrap = __webpack_require__(214);
	var invariant = __webpack_require__(49);
